...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'md' }) => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-surface rounded-lg shadow-xl p-6 m-4 w-full ${sizeClasses} transform transition-all duration-300 ease-in-out ${isOpen && showContent ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}
