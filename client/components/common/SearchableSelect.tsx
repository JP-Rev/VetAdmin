    ...
    <div className={`mb-4 ${className}`}>
      ...
      <div ref={containerRef} className="relative">
        ...
        <button
          ...
          disabled={disabled}
          className={`w-full px-3 py-2 text-left border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 bg-surface flex items-center justify-between ${
        ...
        {/* Dropdown */}
        {isOpen && (
          <div className="absolute z-50 w-full mt-1 bg-surface border border-secondary-300 rounded-md shadow-lg max-h-60 overflow-hidden">
            {/* Search input */}
