...
export const FormField: React.FC<FormFieldProps> = ({
  ...
  const commonInputClasses = `mt-1 block w-full px-3 py-2 border ${error ? 'border-error-500' : 'border-secondary-300'} rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 sm:text-sm ${disabled ? 'bg-secondary-100 cursor-not-allowed' : 'bg-surface'}`;
